...
export const FolderSelector = ({
  ...
  return (
    <div className="w-full h-full flex items-center justify-center p-4 sm:p-6 lg:p-8">
      <div
        className={`
          w-full max-w-4xl h-full max-h-[600px] min-h-[500px] mx-auto 
          p-6 sm:p-8 lg:p-10 border border-border/30 rounded-3xl 
          ...
          ${isDragOver ? "ring-2 ring-primary/40 scale-[1.005] bg-gradient-to-br from-primary/8 to-accent/8 shadow-primary/10" : ""}
        ...
        <div className="relative w-full h-full flex flex-col items-center justify-center space-y-6 lg:space-y-8">
          ...
          <div className="w-full flex-1 flex flex-col justify-center space-y-4 lg:space-y-6 min-h-0">
            <Button
              asChild
              size="lg"
              className="w-full h-14 sm:h-16 lg:h-18 font-semibold text-base sm:text-lg lg:text-xl rounded-2xl bg-gradient-to-r from-primary via-primary to-primary/95 hover:from-primary/95 hover:via-primary/90 hover:to-primary/85 shadow-lg hover:shadow-xl transition-all duration-300 border-0 relative overflow-hidden group flex-shrink-0"
              aria-label="Upload images"
            >
              <label htmlFor="folder-input" className="cursor-pointer flex items-center justify-center gap-3 lg:gap-4 w-full h-full">
            ...
            <div 
              className={`
                w-full flex-1 min-h-[200px] sm:min-h-[250px] lg:min-h-[300px] border-2 border-dashed rounded-3xl 
                py-8 sm:py-12 lg:py-16 px-6 sm:px-8 flex flex-col items-center justify-center 
